      ...
      <section className="relative h-[50vh] flex items-center justify-center text-white text-center px-6">
        ...
        >
          ...
          <div className="mt-4 flex justify-center items-center gap-2 text-xs md:text-sm font-bold uppercase tracking-widest">
            ...
            <span className="text-yellow-600">/ Programs</span>
          </div>
        </motion.div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-12">
          ...
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="lg:pt-14">
            <p className="text-gray-500 text-base mb-6 leading-relaxed">
              At Joseninho Kids Football League, we provide a structured platform where young players can grow, compete, 
              ...
              <div className="p-6 pb-4">
                <div className="flex justify-between items-start mb-4">
                  <div className="max-w-[80%]">
                    <h3 className="text-xl font-bold text-slate-900 uppercase tracking-tight group-hover:text-yellow-600 transition-colors">{prog.title}</h3>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24 max-w-8xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-stretch">
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="flex flex-col h-full">
            ...
            <p className="text-gray-500 mb-8 text-base leading-relaxed">We are committed to Nurturing Grassroots Talent into Competitive Champions</p>

...
//                           <td className="py-6 px-8 text-center font-black text-slate-900 uppercase">
...
//                             <button onClick={() => handleMatchClick(match.id)} className="bg-[#1C1F42]! text-white font-black px-6 py-3 flex items-center gap-2 transition-all rounded-none! uppercase text-xs tracking-wider hover:bg-red-600">
...
//               <button onClick={() => setView('list')} className="absolute top-10 left-10 z-30 flex items-center gap-2 text-xs font-black uppercase tracking-widest text-white/80 hover:text-white transition-colors bg-white/10 px-4 py-2 rounded-full backdrop-blur-md">
//                 <FiChevronLeft size={18} /> Back to Schedule
//               </button>
//               <div className="relative z-20 text-center">
//                 <h1 className="text-6xl font-black uppercase tracking-tighter">Matches Details</h1>
//                 <div className="mt-4 flex justify-center items-center gap-2 text-sm font-bold uppercase tracking-widest">
//                   <span className="text-gray-400">Home</span> <span className="text-red-600">/</span> <span>Matches Details</span>
//                 </div>
//               </div>
//             </section>
...
//                     <div className="relative h-full bg-slate-900 rounded-sm overflow-hidden shadow-2xl border-b-5 border-blue-900">
//                         <AnimatePresence mode="wait">
//                             {!isVideoPlaying ? (
//                                 <motion.div 
//                                     key="teams"
//                                     initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
//                                     className="flex items-center justify-between p-12 h-full"
//                                 >
//                                     <div className="text-center flex-1">
//                                         {/* Removed grayscale class below */}
//                                         <img src={selectedMatch.teamALogo} className="w-20 h-20 mx-auto mb-4 object-contain" alt="" />
//                                         <h4 className="text-white font-black uppercase tracking-tighter text-xl">{selectedMatch.teamA}</h4>
//                                     </div>
//                                     <div className="px-4 text-center">
//                                         <button 
//                                             onClick={() => setIsVideoPlaying(true)}
//                                             className="w-16 h-16 bg-red-600 rounded-full flex items-center justify-center text-white shadow-lg shadow-red-600/40 hover:scale-110 transition-transform mb-2"
//                                         >
//                                             <FiPlay size={24} fill="currentColor" />
//                                         </button>
//                                         <span className="text-white/30 font-black uppercase text-xs tracking-widest">Watch</span>
//                                     </div>
//                                     <div className="text-center flex-1">
//                                         {/* Removed grayscale class below */}
//                                         <img src={selectedMatch.teamBLogo} className="w-20 h-20 mx-auto mb-4 object-contain" alt="" />

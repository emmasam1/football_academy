...
//         "2022": "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. Joseninho Kids Football League continues to evolve as a premier sports hub.",
//       },
...
//       icon: <BulbOutlined />,
//       title: "Our Mission",
//       content: "Our mission is to nurture young football talents through structured training, mentorship, and competitive exposure while instilling discipline, confidence, and teamwork.",
//       image: "https://images.unsplash.com/photo-1551958219-acbc608c6377?q=80&w=1600",
//     },
//     Vision: {
//       icon: <EyeOutlined />,
//       title: "Our Vision",
//       content: "We aim to become a leading youth football development platform in Africa, producing technically sound, mentally strong, and globally competitive players.",
...
//               <img src="/images/aboutImg1.jpeg" alt="Training" className="w-full h-96 object-cover rounded-2xl shadow-2xl" />
//               <div className="absolute bg-white h-24 w-24 -left-6 top-1/2 -translate-y-1/2 shadow-xl rounded-full flex flex-col items-center justify-center border-4 border-gray-50">
...
//               <Button type="primary"  size="large" className="rounded-none h-12 px-10 font-bold uppercase bg-[#97991b]!">Contact Us</Button>
//             </div>
//           </div>
